    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6 bg-[#FAFAFA] min-h-[calc(100vh-56px)]">
        <div className="max-w-md w-full p-6 bg-white border border-[#E5E5E5] rounded-xl shadow-2xs text-center space-y-4">
          ...
          <div>
            <h2 className="text-base font-extrabold text-[#1F1F1F]">Cashier Register Restricted</h2>
            <p className="text-xs text-[#737373] mt-1">
              You are signed in with the <strong>Owner</strong> role. POS register operations are managed by the Cashier.
            </p>
          </div>
          <button
